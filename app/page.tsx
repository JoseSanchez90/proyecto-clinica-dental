  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col items-center justify-center gap-6 2xl:pt-20">
          <div className="flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 xl:gap-24 2xl:gap-28 w-full px-4 sm:px-6 md:px-10">
            ...
            <div className="relative w-full max-w-xs sm:max-w-sm lg:max-w-md xl:max-w-lg 2xl:max-w-2xl text-start space-y-3 md:space-y-4 xl:space-y-6 translate-y-8 sm:translate-y-10 lg:translate-y-0">
              <div className="text-blue-600 -tracking-widest">
                <p className="text-3xl sm:text-4xl lg:text-5xl xl:text-5xl 2xl:text-7xl font-extrabold">
                  CLÍNICA DENTAL
                </p>
                <p className="text-3xl sm:text-4xl lg:text-5xl xl:text-5xl 2xl:text-7xl font-extrabold">
                  SMILE
              ...
              <p className="text-xl sm:text-2xl lg:text-3xl xl:text-2xl 2xl:text-5xl font-semibold text-white">
            ...
            <div className="relative flex justify-center items-center">
              <Image
                src={Dental}
                alt="Dental-image"
                className="w-64 sm:w-80 md:w-96 lg:w-md xl:w-sm 2xl:w-150 object-contain"
              />
              <div className="absolute bottom-[0%] right-[10%] sm:right-[8%] lg:right-[12%] 2xl:right-[14%]">
                <div className="w-24 lg:w-28 2xl:w-32 h-24 lg:h-28 2xl:h-32 bg-blue-600 rounded-full flex items-center justify-center text-white shadow-lg">
                  <SpinningText
                    radius={5}
                    duration={15}
          ...
          <div className="max-w-sm md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl mx-auto px-2">
            <p className="text-white font-medium text-sm sm:text-base lg:text-lg 2xl:text-xl text-balance">
              El{" "}
              ...
              salud oral{" "}
              <Highlighter action="highlight" color="#38A169">
                es importante
              </Highlighter>
            </p>
          </div>
      ...
      <section id="casos" className="w-full min-h-screen">
        <Cases />
      </section>

      <section id="beneficios" className="w-full min-h-screen">
        <Choose />
      </section>

      <section id="preguntas" className="w-full h-full">
        <Faqs />
      </section>
